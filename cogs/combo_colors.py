from disnake import Attachment, Embed, ApplicationCommandInteraction as Interaction
...
def generate_palette_image(palette: Palette) -> Image.Image:
    ...
    """
    # Create a new image with discord dark theme background color
    img = Image.new("RGB", (1000, 600), (43, 45, 49))
    draw = ImageDraw.Draw(img)

    # TODO: Draw the colors in the palette on the image
